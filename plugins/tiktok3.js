...
const ssstiktok = async (tiktokUrl) => {
  if (!regexTiktok.test(tiktokUrl)) throw new Error('URL TikTok non valide')
...
let handler = async (m, { conn, args }) => {
  ...
  try {
    ...
    throw 'Impossible de télécharger la vidéo, de vérifier le lien ou d’essayer plus tard.'
  }
}
